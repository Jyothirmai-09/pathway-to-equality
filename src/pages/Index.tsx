    ...
    >
      <div className="w-full max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-tr from-primary/20 to-blue-400/20 rounded-full blur-3xl opacity-30 animate-pulse-subtle" />
            
            <div className="relative h-full w-full flex items-center justify-center">
              <div className="card-glass rounded-2xl w-full h-full overflow-hidden">
                <img
            ...
            <div className="absolute -bottom-6 -right-6 card-glass p-4 rounded-xl shadow-lg">
